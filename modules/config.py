...
def try_load_deprecated_user_path_config():
    ...
    try:
        ...
        if deprecated_config_dict.get("default_model", None) == 'epicRealism.safetensors':
...
default_base_model_name = get_config_item_or_set_default(
    key='default_model',
    default_value='epicRealism.safetensors',
...
checkpoint_downloads = get_config_item_or_set_default(
    ...
    default_value={
        "epicRealism.safetensors": "https://huggingface.co/mojom2k/epicRealism/blob/main/epicrealism_naturalSinRC1VAE.safetensors"
    },
